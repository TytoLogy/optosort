function [cSweeps, sInfo] = test_data_for_export(F, Channels, BPfilt, resampleRate)
%------------------------------------------------------------------------
% [cSweeps, sInfo] = test_data_for_export(F, Channels, BPfilt, resampleRate)
%------------------------------------------------------------------------
% TytoLogy:Experiments:optosort
%------------------------------------------------------------------------
% 
% creates fake data based on multiple raw .dat files generated by opto
% program
%
...
%------------------------------------------------------------------------
% Created: 16 June, 2020 (forked from read_data_for_export) (SJS)
%
% Revisions:
%------------------------------------------------------------------------
% TO DO:
...
for f = 1:nFiles
	...
	testOpts = define_testOptsStruct(Channels, cInfo{f}.Dinf);
	[cInfo{f}, cSweeps{f}] = ...
				cInfo{f}.buildTimingTestData(Channels, BPfilt, D, ...
															'plot_sweeps', 'n', ...
															'Options', testOpts);
